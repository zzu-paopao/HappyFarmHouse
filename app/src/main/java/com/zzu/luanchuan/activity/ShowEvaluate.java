...
public class ShowEvaluate extends Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_evaluate);
        ...
        EvaluateAdapter ava = new EvaluateAdapter(list,ShowEvaluate.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Toast.makeText(ShowEvaluate.this, "haah", Toast.LENGTH_SHORT).show();
        }
        return true;
    }
}
